...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        wp_register_script('attic-js', get_template_directory_uri() . '/assets/dist/js/styles-dist.js', array('jquery'), '1.0.0', true); // Custom scripts
        wp_enqueue_script('attic-js'); // Enqueue it!
    }
}
...
{
    wp_register_style('attic-styles', get_template_directory_uri() . '/assets/dist/css/styles.css', array(), '1.0', 'all');
    wp_enqueue_style('attic-styles'); // Enqueue it!
}
